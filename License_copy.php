...
/*解析webpower api*/
$client1 = new SoapClient("http://hannoverfairchina.webpower.asia/x/soap-v5.1/wsdl.php");
$client2 = new SoapClient("http://hannuowei.webpower.asia/x/soap-v5.1/wsdl.php");
